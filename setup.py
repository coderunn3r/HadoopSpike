...
#
# However, when we do this, we also import `hadoop_spike/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'hadoop_spike_cli = hadoop_spike.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'hadoop_spike_gui = hadoop_spike.gui:entry_point'
        # ]
    }
)
